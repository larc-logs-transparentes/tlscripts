...
parser.add_argument('--frequencia_log_soma', help='Frequência de atualização do arquivo que guarda o estado do resultado ao longo da soma', type=int, dest='timeline_frequency')